    ...
    return (
        <div className='flex items-center justify-center flex-col gap-5'>
            ...
            <div className='text-center'>{isPaidSuccessfully
                ...
                : <p>پرداخت ناموفق بود، میتونید در داشبود خود مجدد تلاش کنید. این سفارش {toPersianNumber((24).toString())} ساعت <span className='text-yellow-600'>در انتظار پرداخت</span> باقی میمونه و سپس منقضی میشه.</p>
            }</div>
